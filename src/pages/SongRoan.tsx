...
const platforms = [
  {
    ...
    bg: "#1DB954",
    link: "https://open.spotify.com/album/4SmHJ0gX37z3PuIcKwRGoo?si=CaKKvR6ISmy-0Lv7KDziCw",
  },
  {
    name: "Apple Music",
    logo: "https://cdn.simpleicons.org/applemusic/FA243C",
    bg: "#FA243C",
    link: "https://geo.music.apple.com/album/request-of-a-n-a-single/6779195226?app=music",
  },
  {
    name: "Audiomack",
  ...
  },
  {
    ...
    bg: "#FF0000",
    link: "https://www.boomplay.com/songs/254466429?from=search",
  },
  {
    name: "Deezer",
    logo: "https://cdn.simpleicons.org/deezer/A238FF",
    bg: "#A238FF",
    link: "https://www.deezer.com/album/1003094091",
  },
  {
    name: "YouTube Music",
    ...
    <div className="min-h-screen bg-[#080808] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <h1 className="text-white text-4xl font-bold font-['Oswald'] uppercase">Request of a Nigga</h1>
